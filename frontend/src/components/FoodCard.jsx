...
const FoodCard = ({ id, donor, foodName, category, quantity, location, image }) => {
  return (
    <div className="flex flex-col md:flex-row items-center bg-white border border-gray-200 rounded-xl shadow-md transition overflow-hidden">
      ...
      <div className="p-5 flex flex-col justify-between w-full md:w-2/3">
        ...
        <div className="flex gap-3">
          ...
          {/* ✅ FIXED Reserve Pickup Button */}
          <Link
            to="/reserve"   // 🔥 matches your App.jsx route
            state={{ id, donor, foodName, category, quantity, location, image }}
          >
          ...
          {/* Read More */}
          <Link to={`/food/${id}`} state={{ city: location }}>
