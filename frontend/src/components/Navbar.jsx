...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-200/90 backdrop-blur border-blue-300 fixed top-0 w-full z-10 shadow-sm">
          ...
          <ul className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8 bg-white md:bg-transparent p-4 md:p-0 rounded-lg md:rounded-none shadow md:shadow-none">
              ...
              <>
                ...
                <li>
                  <button
                    ...
                    className="text-gray-700 hover:text-blue-700 transition text-sm cursor-pointer"
                  >
                    Logout
                  </button>
                </li>
            ...
            <li>
              <button
                ...
                className="bg-blue-600 text-white px-5 py-2 rounded-lg text-sm hover:bg-blue-700 transition shadow-sm cursor-pointer"
              >
                Donate now
              </button>
            </li>
