...
const Navbar = () => {
  ...
  return (
    <div>
      <nav className="bg-blue-100 w-full border-b border-gray-300 fixed top-0">
          ...
          >
            ...
            >
              <li>
                <Link
                  to="/Login"
                  className="block py-2 px-2 text-white bg-blue-600 md:bg-transparent md:text-blue-700 "
                >
                  Login
                </Link>
              </li>
              ...
              <li>
                <Link className="block py-2 px-2 text-gray-800 hover:text-blue-700">
                  Profile
                </Link>
              </li>
            </ul>
